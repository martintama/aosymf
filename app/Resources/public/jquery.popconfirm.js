    ...
    popConfirm: function (options) {
      ...
      return this.each(function () {
        ...
        self.popover({
          ...
          content: options.content + '<p class="button-group" style="margin-top: 10px; text-align: center;"><button type="button" class="btn btn-small btn-success confirm-dialog-btn-confirm">' + options.yesBtn + '</button><button type="button" class="btn btn-small btn-danger confirm-dialog-btn-abord">' + options.noBtn + '</button></p>'
        }).click(function (e) {
          if (last && last !== self) {
